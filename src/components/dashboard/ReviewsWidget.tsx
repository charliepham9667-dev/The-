...
export function ReviewsWidget() {
  ...
  return (
    <div className="rounded-xl border border-[#374151] bg-[#1a1f2e] p-5 h-full">
      <h3 className="text-lg font-semibold text-white mb-4">Service & Reviews</h3>
        ...
        <div className="ml-auto">
          <div className="relative h-12 w-12">
            ...
            <div className="absolute inset-0 flex items-center justify-center">
              <span className="text-xs font-bold text-green-400">{sentiment}%</span>
            </div>
          </div>
          <p className="text-xs text-slate-400 text-center mt-1">Sentiment</p>
        </div>
      </div>
      ...
      <div className="space-y-4">
        {recentReviews.map((review, index) => (
          <div key={index} className="border-t border-[#374151] pt-4">
