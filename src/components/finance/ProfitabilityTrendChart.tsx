    ...
    <div className={`rounded-xl border border-[#374151] bg-[#1a1f2e] p-4 ${className}`}>
      ...
      <div className="flex items-start justify-between mb-4">
        <div>
          ...
          <div className="mt-2">
            <span className={`text-2xl font-bold ${totalProfit >= 0 ? 'text-emerald-400' : 'text-red-400'}`}>
              {formatVND(totalProfit)}
            </span>
            <span className="text-sm text-slate-400 ml-2">Net Income (EBIT)</span>
          </div>
          {growth !== 0 && (
        ...
        {/* Time range toggle */}
        <div className="flex rounded-lg border border-[#374151] overflow-hidden">
