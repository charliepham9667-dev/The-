...
export function PLAlertsPanel({ currentData, previousData, budgetData, className = '' }: PLAlertsPanelProps) {
  const alerts = generateAlerts(currentData, previousData, budgetData);
  ...
  return (
    <div className={`rounded-xl border border-[#374151] bg-[#1a1f2e] p-4 ${className}`}>
      <div className="flex items-center justify-between mb-4">
        <h3 className="text-sm font-medium text-white">Bottom Line Alerts</h3>
        {hasCritical && (
      ...
      <button className="w-full mt-4 py-2 text-sm text-slate-400 hover:text-white border border-[#374151] rounded-lg hover:bg-[#374151] transition-colors">
